...
httpServer.listen(PORT, '0.0.0.0', () => {
  ...
  // ⬡B:heartbeat:DISABLED:cost_fix:20260309⬡
  // DISABLED TO STOP BURNING CLAUDE CREDITS
  // startHeartbeat();
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ⬡B:cron:DISABLED:cost_fix:20260309⬡
  // DISABLED - Internal cron burns Claude credits
  console.log('[CRON] DISABLED - Internal cron disabled to save costs');
  const DISABLED_CRON = async () => {
    try {
      const dueCalls = await checkScheduledCalls();
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ⬡B:pulse:DISABLED:cost_fix:20260309⬡
  // DISABLED TO STOP BURNING CLAUDE CREDITS
...
// ⬡B:autonomous:DISABLED:cost_fix:20260309⬡
  // DISABLED TO STOP BURNING CLAUDE CREDITS
